...
import shapeStyle from './shapeStyle.module.scss'

const Shapes = () => {
  return (
    <div className={shapeStyle.shapes}>
        <svg
        width="27"
        height="29"
        className={`${shapeStyle.shape} ${shapeStyle.s1}`}
      ...
      <svg
        width="26"
        height="26"
        className={`${shapeStyle.shape} ${shapeStyle.s2}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="30"
        height="25"
        className={`${shapeStyle.shape} ${shapeStyle.s3}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="15"
        height="23"
        className={`${shapeStyle.shape} ${shapeStyle.s4}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="15"
        height="23"
        className={`${shapeStyle.shape} ${shapeStyle.s5}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
          transform="rotate(30 9.86603 10.13397)"
      ...
      <svg
        width="49"
        height="17"
        className={`${shapeStyle.shape} ${shapeStyle.s6}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="26"
        height="26"
        className={`${shapeStyle.shape} ${shapeStyle.s7}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="19"
        height="21"
        className={`${shapeStyle.shape} ${shapeStyle.s8}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <rect
      ...
      <svg
        width="30"
        height="25"
        className={`${shapeStyle.shape} ${shapeStyle.s9}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
      ...
      <svg
        width="47"
        height="29"
        className={`${shapeStyle.shape} ${shapeStyle.s10}`}
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <svg
        width="33"
        height="20"
        className={`${shapeStyle.shape} ${shapeStyle.s11}`}
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
